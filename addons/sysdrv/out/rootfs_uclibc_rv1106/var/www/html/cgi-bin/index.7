...
echo ".container { width: 90%; max-width: 1200px; margin: 20px auto; background: #fff; border-radius: 10px; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); }"
echo ".logo { margin-bottom: 20px; }"
echo ".logo img { max-width: 150px; height: auto; }"
...
# Add the logo
echo "<div class='logo'><img src='/logo.png'></div>"
